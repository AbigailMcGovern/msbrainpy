...
# ---------------------- Correctly place and name files + remove prior files for TeraStitcher  -------------------------
# Somewhere in the middle of refactoring the writeTerraFiles() function, never finished this.
