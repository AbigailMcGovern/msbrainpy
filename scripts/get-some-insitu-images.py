...
download_gene_images(entrez_id=242443, directory_path=gene_directory)
...
download_gene_images(entrez_id=17202, directory_path=gene_directory)

# get the in situ data for gene Grin2b (ID: 14812)
#   WHY: have aquired an equivalent image series from gene paint
download_gene_images(entrez_id=14812, directory_path=gene_directory)
